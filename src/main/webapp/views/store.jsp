		...
		<div id="top-header">
			<div class="container">
				...
				<ul class="header-links pull-right">
					...
					<!-- /logout là đường dẫn mặc định của security, nếu muốn đổi đường dẫn khác thì phải config  -->
			...
			<div class="row">
							...
							<c:forEach items="${categoriesActice }" var="o">
								<div class="input-checkbox">
									<input type="checkbox" id="category-1"> <label
										for="category-1"> <span></span> ${o.name } <small>(120)</small>
									</label>
								</div>
							</c:forEach>
						</div>
				...
				<div id="store" class="col-md-9">
					...
					<div class="row">
						...
						<c:forEach items="${productDTOs }" var="o">
							<!-- product -->
